...
# Base Adapter: adapters_solverx_cpt

echo "Starting LoRA SFT fine-tuning with Early Stopping..."

# Ensure the output directory exists
mkdir -p adapters_solverx_sft
...
/Users/user/ml-lora-ax-lab/.venv/bin/python train_with_early_stopping.py \
    ...
    --iters 400 \
    --learning-rate 1e-5 \
    --adapter-path adapters_solverx_sft \
    --resume-adapter-file adapters_solverx_cpt/adapters.safetensors \
    --save-every 50 \
    --patience 5 \
    --min-delta 0.001 \
    --seed 42
